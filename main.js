...
function left() {
    if (player_x >= 0) {
        ...
        console.log("cuando se presiona la tecla hacia izquierda x = " + player_x + "y = " + player_y);
        canvas.remove(player_object);
        player_update();
    }
}
...
function right() {
    if (player_x<= 850) {
        player_x = player_x + block_image_width;
        console.log("ancho del bloque = " + block_image_width);
        console.log("cuando se presiona la tecla hacia derecha x = " + player_x + "y = " + player_y);
        canvas.remove(player_object);
        player_update();
    }
}
